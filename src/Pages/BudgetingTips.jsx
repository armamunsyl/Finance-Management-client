        ...
        <section className="bg-base-100 py-16 px-6 md:px-20">
            <div className="max-w-5xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-base-200 border border-base-300 rounded-2xl p-6 hover:shadow-lg transition-all duration-300">
                        <h3 className="text-xl font-semibold text-[#22C55E] mb-2">
                            Track Every Expense
                        </h3>
                        <p className="text-base-content/70 text-sm">
                            Keep a daily record of all your expenses — even the small ones. It helps you identify unnecessary spending and plan better.
                        </p>
                    </div>
